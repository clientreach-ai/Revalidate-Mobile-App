        ...
        >
          ...
          >
            ...
            <Pressable
              ...
              className={`mb-6 p-4 rounded-2xl border flex-row items-center justify-center gap-2 ${
                isDark
            ...
            <View className="mb-6">
              <Text
                className={`text-sm font-semibold mb-3 ${
                  showErrors && missing.selectedDate
                    ? 'text-red-500'
                    : isDark
                      ? 'text-slate-400'
                      : 'text-slate-500'
            ...
            <View className="mb-6">
              <Text
                className={`text-sm font-semibold mb-3 ${
                  showErrors && missing.selectedHospital
                    ? 'text-red-500'
                    : isDark
                      ? 'text-slate-400'
                      : 'text-slate-500'
            ...
            <View className="mb-6">
              <Text
                className={`text-sm font-semibold mb-3 ${
                  showErrors && missing.workSetting
                    ? 'text-red-500'
                    : isDark
                      ? 'text-slate-400'
                      : 'text-slate-500'
