...
export const create = asyncHandler(async (req: Request, res: Response) => {
  ...
  res.status(201).json({
    ...
    data: {
      ...
      hourlyRate: workHours.hourly_rate ? parseFloat(workHours.hourly_rate.toString()) : null,
      totalEarnings: workHours.total_earnings ? parseFloat(workHours.total_earnings.toString()) : null,
...
export const getActive = asyncHandler(async (req: Request, res: Response) => {
  ...
  res.json({
    ...
    data: {
      ...
      hourlyRate: active.hourly_rate ? parseFloat(active.hourly_rate.toString()) : null,
      totalEarnings: active.total_earnings ? parseFloat(active.total_earnings.toString()) : null,
...
export const update = asyncHandler(async (req: Request, res: Response) => {
  ...
  res.json({
    ...
    data: {
      ...
      hourlyRate: updated.hourly_rate ? parseFloat(updated.hourly_rate.toString()) : null,
      totalEarnings: updated.total_earnings ? parseFloat(updated.total_earnings.toString()) : null,
